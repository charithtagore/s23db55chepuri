...
router.get('/', function (req, res) { 
    res.render('index', { title: 'earphone App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'earphone App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'earphone App Login', user : req.user }); 
}); 
